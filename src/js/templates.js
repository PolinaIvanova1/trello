            ...
            <div class="trello__list__dynamic__item 
                ...
                ${isDone ? `trello__list__dynamic__item__orange` : ''}" id="${task.id}">
                    ...
                    <div class="trello__list__dynamic__item__change">
                        ...
                        <button type="button" class="btn btn-outline-secondary btn-sm trello__list__dynamic__item__change__edit" data-role="editTodo"">Edit</button>
                        <button type="button" class="btn btn-outline-secondary btn-sm trello__list__dynamic__item__change__delete ${isInProgress ? `trello__list__dynamic__item__hide` : ''}" data-role="removeTodo">Delete</button>
                    </div>
            </div>
`;
};
